...
\begin{enumerate}
\item Coeficiente ângular\boxed{b \approx 0.2793 ; b^{-1} \approx 3.5809}
\item \boxed{a \approx 0.0792}
\end{enumerate}
Portando, temos \boxed{A_V \approx 3.5809\frac{V}{V} \pm 0.0792s}
\begin{figure}[!htb]
  \centering
  \label{itransf}
...
\begin{figure}[!htb]
  \centering
  \subfloat[f $\approx 20Hz$]{
    \includegraphics[scale=0.35]{img/h20.jpg}
  }
  \subfloat[f $\approx 60Hz$]{
    \includegraphics[scale=0.35]{img/h50.jpg}
  }
  \caption{Histereses}
\end{figure}
\end{document}
